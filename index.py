...
#Definir el n�mero de pasos en cada animaci�n
...
#Funci�n para dibujar barras de salud de luchadores
...
while run:
  ...
  draw_text("Jugador 1: " + str(score[0]), score_font, RED, 20, 60)
  draw_text("Jugador 2: " + str(score[1]), score_font, RED, 580, 60)
